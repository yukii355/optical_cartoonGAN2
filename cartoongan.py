...
from torch.nn import Conv2d, ConvTranspose2d, LeakyReLU, ReLU, BatchNorm2d, InstanceNorm2d
...
class discriminator(nn.Module):
    ...
    def __init__(self, in_dim):
        ...
        self.dis = nn.Sequential(
            ...
            Conv2d(in_channels=in_dim, out_channels=16, kernel_size=3, stride=1, padding=1, bias=False),
            BatchNorm2d(16),

            LeakyReLU(0.2, True),
            nn.Dropout2d(0.5),
            Conv2d(in_channels=16, out_channels=32, kernel_size=3, stride=2, padding=1, bias=False),
            BatchNorm2d(32),

            LeakyReLU(0.2, True),
            nn.Dropout2d(0.5),
            Conv2d(kernel_size=3, in_channels=32, out_channels=64, stride=1, padding=1, bias=False),
            BatchNorm2d(64),
            LeakyReLU(0.2, True),
            nn.Dropout2d(0.5),
            ...
            Conv2d(kernel_size=3, in_channels=128, out_channels=1, stride=1, padding=1, bias=False),
            nn.Sigmoid())
